...
library(RTutor)
check.problem.set('RTutorMediaPersuasion2', ps.dir, ps.file, user.name=user.name, reset=FALSE)
...
info("foreign -- read.dta()") # Run this line (Strg-Enter) to show info
...
info("dplyr -- mutate()") # Run this line (Strg-Enter) to show info
...
info("dplyr -- select()") # Run this line (Strg-Enter) to show info
...
info("dplyr -- group_by() and summarize()") # Run this line (Strg-Enter) to show info
...
info("Watch_probit_1999") # Run this line (Strg-Enter) to show info
...
info("dplyr -- filter()") # Run this line (Strg-Enter) to show info
...
info("lfe -- felm(): OLS") # Run this line (Strg-Enter) to show info
...
info("lfe -- felm(): fixed effects") # Run this line (Strg-Enter) to show info
...
info("lfe -- felm(): Clustered Standard Errors") # Run this line (Strg-Enter) to show info
...
info("base -- is.na()") # Run this line (Strg-Enter) to show info
...
info("tidyr -- spread()") # Run this line (Strg-Enter) to show info
